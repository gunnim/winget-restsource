...
Function New-ARMParameterObject
{
    ...
    BEGIN
    {
        ...
        # Modifications, the monitoring values probably make no sense since I have no understanding of Geneva / GCS
        $ManifestCacheEndpoint = "/packageManifests/"
        $MonitoringRole = "ReadOnly"
        $MonitoringMetricsAccount = "admin"
            ...
            @{  ObjectType = "Function"
                ...
                Parameters = @{
                    ...
                    Parameters = @{
                        ...
                        manifestCacheEndpoint    = @{ value = $ManifestCacheEndpoint }
                        monitoringRole    = @{ value = $MonitoringRole }
                        monitoringMetricsAccount    = @{ value = $MonitoringMetricsAccount }
                    }
                }
            }#,
